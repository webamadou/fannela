...
class Admin::CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_country" do
    assert_difference('Admin::Country.count') do
      post admin_countries_url, params: { admin_country: { code_iso: @admin_country.code_iso, name: @admin_country.name, state: @admin_country.state } }
    end
  ...
  test "should update admin_country" do
    patch admin_country_url(@admin_country), params: { admin_country: { code_iso: @admin_country.code_iso, name: @admin_country.name, state: @admin_country.state } }
